		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">All Lession Chapters Converted Video</div>
							...
							@foreach($data as $single)
								<tr>
									...
									<td>
										...
										<a href="{{asset('lessions') . '/' . $single->low_video}}" target="_blank">View</a>
										@endif
										@if($single->med_status == 1)
										<a href="{{asset('lessions') . '/' . $single->med_video}}" target="_blank">View</a>
										@endif
										@if($single->high_status == 1)
										<a href="{{asset('lessions') . '/' . $single->high_video}}" target="_blank">View</a>
										@endif
										<a href="{{route('admin.approveVideoLessionChapter',['id'=> $single->id])}}">Approve</a>
