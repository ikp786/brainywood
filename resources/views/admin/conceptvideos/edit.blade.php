	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">Edit Concept Video</div>
				<div class="panel-body">
					...
					<form action="{{route('admin.updateConceptVideo',['id'=> $data->id])}}" class="" id="form1" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							@if($data->video_thumb)
							<div class="img-wrap">
							    <a href="{{route('admin.imgremoveConceptVideo', $data->id)}}"><span class="close">&times;</span></a>
							    <img src="{{asset('/upload/conceptvideos/'.$data->video_thumb)}}" width="100">
							</div>
							@endif
						</div>
						...
						<div class="form-group">
							...
							<div class="vid-wrap">
							    <a href="{{route('admin.vidremoveConceptVideo', $data->id)}}"><span class="close">&times;</span></a>
								<iframe width="560" height="315" src="{{asset('/upload/conceptvideos/'.$data->video)}}" frameborder="0" controls="0" autoplay="0" allowfullscreen sandbox></iframe>
							</div>
						</div>
