		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">All About Us</div>
						...
						<table class="table table-bordered" id="courses">
							...
							@foreach($data as $single)
								<tr>
									...
									<!-- <td>
										<?php if($single->status==1) { ?><a href="<?php echo url('admin/pages/updateStatus') ?>/<?php echo $single->id; ?>/0" class="label label-success">Deactive</a> <?php } else { ?><a href="<?php echo url('admin/pages/updateStatus') ?>/<?php echo $single->id; ?>/1" class="label label-danger">Active</a> <?php } ?>
									</td> -->
									<td>
										<a href="{{route('admin.editAboutUs',['id'=> $single->id])}}">Edit</a>
